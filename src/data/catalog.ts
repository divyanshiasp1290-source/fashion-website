...
export const products: Product[] = [
  {
    ...
    story: "Cut for an oversized editorial silhouette, the R-F-A Jersey brings Makeeva’s visual language into a breathable ready-to-wear piece.",
  ...
  },
  {
    ...
    story: "A unified silhouette with high-contrast wash treatments and Makeeva graphics, designed as a complete look rather than separates.",
  ...
  },
  {
    ...
    story: "A fierce two-piece campaign look that compresses Makeeva’s graphic confidence into a summer uniform.",
  ...
  },
  {
    ...
    story: "A visual dispatch from the SS24 universe, pairing everyday wearability with a strong Makeeva signature.",
